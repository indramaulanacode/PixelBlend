...
export default function CardLayout() {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 md:hidden flex justify-center items-center pointer-events-none">
        <Image
          src="/bg-second.png"
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {card.map((item, index) => (
            ...
            >
              <Card
                className="p-6 h-full bg-[#26262652] hover:bg-[#26262680] transition-all duration-300 hover:scale-105"
                isBlurred
              >
                <CardHeader className="pb-4 pt-0 px-0 flex-col items-start space-y-4">
                  {/* Icon and Title */}
                  <div className="flex flex-row gap-3 items-center w-full">
                    <div className="flex-shrink-0">
                      <div className="w-12 h-12 bg-gradient-to-br from-[#8CC63F] to-[#06231D] rounded-full flex items-center justify-center">
                        <svg
