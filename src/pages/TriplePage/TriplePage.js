...
export default function TriplePage() {
  ...
  return (
    <div className="">
      <div className="flex gap-2 mt-20 relative max-md:mt-[350px] ">
        <div className="absolute top-[-180px] left-[1px]  z-[-999] ">
          <Image
            src="/bg-second.png"
            alt="img"
            width={800}
        ...
        <motion.div className="max-md:w-[100%] overflow-hidden flex-1">
          ...
          {/* <Image src="/bg-video.png" alt="img" width={400} height={400} className="w-auto  max-md:w-[100%] h-auto" /> */}
          <Card className="py-4 w-[60%] max-md:w-[100%] mt-8">
        ...
        <div className="max-md:absolute max-md:top-[-300px] overflow-hidden">
          <motion.h1
            className={`${inter.className}  text-[54px] font-bold leading-[52px]`}
            initial={{ translateX: 100, opacity: 0 }}
            viewport={{ once: true }}
            whileInView={{ translateX: 0, opacity: 1 }}
            transition={{
          ...
          >
            {" "}
            <span className="text-[#FFD600]">Motion Graphic</span> Present
          </motion.h1>
          <motion.h2
            className="mt-3"
            initial={{ translateX: 100, opacity: 0 }}
